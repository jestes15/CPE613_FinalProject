...
chol = (
	...
	('testing_zpotrf_gpu', '--version 2 -L   -c2',  n,    ''), # zpotrf_native, lower
	('testing_zpotrf_gpu', '--version 2 -U   -c2',  n,    ''), # zpotrf_native, upper
	...
	('testing_zpotrf_gpu', '--version 4 -L   -c2',  n,    ''), # zpotrf_native, expert api, lower
	('testing_zpotrf_gpu', '--version 4 -U   -c2',  n,    ''), # zpotrf_native, expert api, upper
