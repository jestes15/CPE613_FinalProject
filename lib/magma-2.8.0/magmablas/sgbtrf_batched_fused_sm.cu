/*
    -- MAGMA (version 2.8.0) --
       ...
       @generated from magmablas/zgbtrf_batched_fused_sm.cu, normal z -> s, Thu Mar 28 12:28:14 2024
*/
    ...
    magma_int_t batchCount, magma_queue_t queue )
{
    ...
    cudaError_t e = cudaLaunchKernel((void*)sgbtrf_batched_kernel_fused_sm, grid, threads, kernel_args, shmem, queue->cuda_stream());
    if( e != cudaSuccess ) {
